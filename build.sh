...
python `openrave-config --python-dir`/openravepy/_openravepy_/ikfast.py --robot=./urdf/ur5.dae --iktype=transform6d --baselink=0 --eelink=25 --savefile=./src/ur5_ikfast.cpp
